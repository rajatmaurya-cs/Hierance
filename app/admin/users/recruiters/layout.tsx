...
export default function JobSeekersLayout({
  ...
  const tabs = [
    {
      name: "Analytics",
      href: "/admin/users/recruiters/analytics",
      icon: <HiChartBar />,
    },
    {
      name: "Profiles",
      href: "/admin/users/recruiters/profiles",
      icon: <FaUser />,
    },
  ];
  ...
  return (
    <section className="flex flex-col gap-6 w-full p-6">
      {/* page header */}
      <div>
        <h1 className="text-2xl font-bold text-neutral-900">Recruiters</h1>
        <p className="text-sm text-neutral-500">
          Manage and analyze recruiters activity
        </p>
      </div>
