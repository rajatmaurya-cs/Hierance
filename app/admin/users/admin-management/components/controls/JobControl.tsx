...
import { Briefcase, ArrowRight, ShieldCheck, Clock, Settings } from "lucide-react";
...
export default function JobControl({ role }: Props) {
  return (
    <div className="flex flex-col">
      <div className="px-6 pt-6 pb-5 border-b border-gray-100 bg-white">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-blue-500 flex items-center justify-center shadow-sm flex-shrink-0">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mt-0.5">
              Current Access Level: <span className="font-bold text-blue-500">{role.replace("_", " ")}</span>
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="p-8 bg-gray-50 flex flex-col items-center text-center justify-center">
        ...
        <p className="text-sm text-gray-500 max-w-md mb-8">
          The comprehensive job tracking and post management system is hosted in its dedicated platform module.
        </p>

        <div className="flex gap-4">
          <Link 
            href="/admin/platform-management/jobs/profiles" 
          ...
          >
            Go to Jobs Module <ArrowRight size={16} />
          </Link>
