...
"[project]/shared/components/JobsBrowser/JobsBrowser.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function JobsBrowser({ filterType, filterValue }) {
    ...
    const baseJobs = __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$data$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockJobs"].filter((job)=>{
    ...
    // Display Jobs State
    const [filteredJobs, setFilteredJobs] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(baseJobs);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "JobsBrowser.useEffect": ()=>{
            let result = baseJobs;
            // Search Query Filter
            if (searchQuery) {
                const query = searchQuery.toLowerCase();
                result = result.filter({
                    "JobsBrowser.useEffect": (job)=>job.title.toLowerCase().includes(query) || job.company.toLowerCase().includes(query) || job.category.toLowerCase().includes(query)
                }["JobsBrowser.useEffect"]);
            }
            // Job Type Filter
            if (selectedTypes.length > 0) {
                result = result.filter({
                    "JobsBrowser.useEffect": (job)=>selectedTypes.includes(job.jobType)
                }["JobsBrowser.useEffect"]);
            }
            // Category Filter
            if (selectedCategories.length > 0) {
                result = result.filter({
                    "JobsBrowser.useEffect": (job)=>selectedCategories.includes(job.category)
                }["JobsBrowser.useEffect"]);
            }
            // Salary Filter
            result = result.filter({
                "JobsBrowser.useEffect": (job)=>job.salaryMax >= salaryRange
            }["JobsBrowser.useEffect"]);
            // Location Filter
            if (location) {
                result = result.filter({
                    "JobsBrowser.useEffect": (job)=>job.location.toLowerCase().includes(location.toLowerCase())
                }["JobsBrowser.useEffect"]);
            }
            // Posted Date Filter
            if (postedDay !== "all") {
...
_s(JobsBrowser, "YcELk7qHDYXjs7dAtiW/nG8sRGo=", false, function() {
    return [
...
_c = JobsBrowser;
var _c;
__turbopack_context__.k.register(_c, "JobsBrowser");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/jobs/company/[companyName]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$components$2f$JobsBrowser$2f$JobsBrowser$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/shared/components/JobsBrowser/JobsBrowser.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function CompanyJobsPage() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$components$2f$JobsBrowser$2f$JobsBrowser$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
        filterType: "company",
...
_s(CompanyJobsPage, "+jVsTcECDRo3yq2d7EQxlN9Ixog=", false, function() {
    return [
...
_c = CompanyJobsPage;
var _c;
__turbopack_context__.k.register(_c, "CompanyJobsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_a08f296d._.js.map